            ...
            <div class="card-body">
                    ...
                    <div class=" d-flex justify-content-between flex-wrap flex-md-nowrap flex-row-reverse align-items-center pt-2 pb-2">
                        ...
                        <form class="form-inline" method="get">
                            ...
                            <input type="text" class="form-control form-control-sm mt-2 ml-1" name="keyword" value="" placeholder="keyword">
                            <button type="submit" class="btn btn-sm btn-primary mt-2 ml-1">Search</button>
                            <a href="" class="btn btn-sm btn-outline-primary mt-2 ml-2">Clear</a>
                        </form>
                        <strong>Record: <?php echo $txn_count; ?></strong>
