                ...
                <form action="" method="post" enctype='multipart/form-data' >
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="upi_id" class="form-control" value="" id="upi_id" placeholder="UPI Id" />
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="bank_name" class="form-control" value="" id="bank_name" placeholder="Bank Name" />
                            <small class="text-danger" id="bank_name_error"></small>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="account_holder_name">Account holder Name</label>
                            <input type="hidden" id="account-holder-name" value="">
                            <input type="text" name="account_holder_name" class="form-control" value="" id="account_holder_name" placeholder="Account Holder Name" />
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="hidden" id="bank-name" value="">
                            <input type="text" name="bank_account_no" class="form-control" value="" id="bank_account_no" placeholder="Bank Account Number" />
                            <small class="text-danger" id="bank_account_no_error"></small>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="IFSC_code">IFSC Code</label>
                            <input type="hidden" id="ifsc-code" value="">
                            <input type="text" name="ifsc_code" class="form-control" value="" id="ifsc_code" placeholder="IFSC code" />
...
<script>
    ...
    var url='<?php echo site_url('mapp/Account/add'); ?>';
