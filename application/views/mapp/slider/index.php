...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-3 ">
    <h1 class="h4">Slider</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="<?php echo site_url('mapp/slider/edit'); ?>" class="btn btn-sm btn-primary ml-2"> Add New Slider</a>
    </div>
</div>
            ...
            <div class="card-body">
                    <div class=" d-flex justify-content-between flex-wrap flex-md-nowrap flex-row-reverse align-items-center pt-2 pb-2">
                        <form class="form-inline" method="get">
                            ...
                            <a href="<?php echo site_url('mapp/slider'); ?>" class="btn btn-sm btn-outline-primary  ml-2">Clear</a>
                        </form>
                        <form action="<?php echo base_url('mapp/slider/change_status'); ?>" method="POST">
                                    ...
                                    foreach($result as $row){
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                  <img style="max-height:60px;" src="<?php echo public_path('slider/'.$row->slider_image); ?>">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a class="btn btn-outline-primary btn-sm" href="<?php echo site_url('mapp/slider/edit/'.$row->id) ?>" ><span class="fa fa-pencil-alt"><span></a>
                                                </td>
                                            </tr>
